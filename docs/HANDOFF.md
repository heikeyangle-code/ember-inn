...
- 引擎测试本机可跑（Java 21 + Gradle 9.7，当前 **367 测全绿**）；App 编译只能靠 CI（本机无 Android SDK）。
...
- 引擎测试 **367 例全绿**；差分分组表 96 行（表内例数合计 2984；历史“85 组/1969 例”为旧口径，不再使用），明细见 [docs/DIFF_MATRIX.md](DIFF_MATRIX.md)。
