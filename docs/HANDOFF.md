...
- 艺术扩展六字段（默认全关；官方主题恒关；实现全在 ArtBackdrop.kt）：
  ...
  - `texture` 底材纹理 = **TextureSpec 六图元自由配方**（不再是 3 选 1）：weave 织纹（主线+错位辅线两级、逐段抖动）/ stipple 布点 / hatch 定向排线（角度可调）/ crossHatch 交叉排线 / fiber 微弯长纤维 / grain 细颗粒，六种密度 + 角度 + 缩放 + 强度 + 着色任意组合；drawWithCache 预生成一次（固定随机种子不闪烁），至多 7 次批量 drawPoints 画在内容之下，滚动/重组零开销；设置→外观可全局自定义（跟随主题/自定义双模式 + 9 滑杆 + 实时预览，LocalTextureOverride 贯通，TexturePrefs 持久化）
...
| 组 | 主题 | 画种 · 关键性格 |
|---|---|---|
| 基础 11 | 墨韵 ink | 水墨：宣纸草筋纤维+微尘，朱砂宝石 + 冷银金属 + 墨青天/青雾晨光，rounded 慢 0.85x |
| | 青瓷 celadon | 瓷器：全场唯一无纹理彩色主题（釉面光滑即身份），天青夜/暖沙晨光 aura |
| | 夜航 night | 透纳海景：画布织纹+海盐颗粒 + 黄铜金属，灯塔琥珀宝石，深海夜天/灯塔晨光 |
| | 丹砂 cinnabar | 篆刻金石：蚀刻排线 60°+交叉（刀痕）+ 印泥朱宝石 + 刻石白金属，square 快 1.15x |
| | 琉璃 glaze | 玻璃器：无纹高反差 1.3 + 紫宝石/青金属，circle，紫夜/淡紫玻璃光 |
| | 石墨 paper | 石墨素描：全场唯一无宝石无金属（极简即身份），铅笔排线 30°+交叉+炭粉颗粒，灰纸光 |
| | 竹青 bamboo | 竹园晨雾：竹叶长纤维+雾尘 + 竹黄宝石/苔色金属，黛绿夜天/竹雾晨光 |
| | 暮紫 dusk | 暮霭水彩：暮尘布点+水彩颗粒 + 落日橙宝石/紫银金属，紫暮天/暮光橙 |
| | 晨雾 mist | 全场唯一低反差 0.9（雾压平明暗），雾滴布点+湿颗粒（intensity 0.8 收敛）+ 晨光金宝石 |
| | 樱粉 sakura | 樱吹雪：落瓣大布点（scale 1.5）+花瓣纤维 + 樱绯宝石/粉银金属，暮樱紫天/樱霞光 |
| | 酒馆官方 st | 官方 SmartTheme 逐值还原，无滤镜/纹理/氛围（恒定豁免） |
| 艺术向 7 | 熔金 molten | 电影 teal&orange：粗织纹（scale 1.35）+胶片颗粒 + 熔金金属/余烬宝石，金夜天/金色黄昏光 |
| | 靛夜 indigo | 梦境星夜：星尘布点（scale 1.3）+微颗粒 + 星尘青宝石/月银金属，靛蓝天/淡靛光 |
| | 琥珀 amber | 古典油画：老画布粗织纹（scale 1.5）+龟裂颗粒 + 烛光琥珀/威尼斯红宝石，画布夜天/暖琥珀光 |
| | 黛山 inkwash | 水墨留白：宣纸纤维最重（草筋横陈）+雾尘，枯金宝石，最慢 0.8x 最松 1.18x，青灰山雾光 |
| | 深海 abyss | 万米幽光：浮游光斑大布点（scale 1.8）+悬浮微粒 + 浮游青绿宝石，深海 aura/浅海青光 |
| | 胶片 film | 柯达褪色：银盐颗粒全场最重+相纸微尘 + 褪棕宝石/灰青金属，褪色暖调光 |
| | 霓虹 neon | 雨夜霓虹：无纹方正（湿玻璃）+ 品红宝石/青金属，最快 1.1x，雨后粉紫光 |
| 画廊 6 | 猩红王座 crown | 巴洛克骷髅王：宫廷粗织挂毯（scale 1.6）+金粉颗粒 + 古金主色 + 红宝石光晕 + 暗青战场天/金色晨光，黑曜石王座厅 |
| | 白鹰圣殿 knight | 白马白鹰圣殿：大理石云纹纤维+石粉颗粒 + 象牙白主色 + 暗红宝石，蓝灰夜空/象牙晨光，square 庄重 |
| | 赤月森林 vermilion | 红月孤影：血月浮尘（scale 1.4）+ 红黑有限色调（枯金/月象牙次色），circle，血月天/绯薄暮光 |
| | 亡者圣堂 requiem | 白袍玫瑰：蚀刻全工艺（排线+交叉+布点三件套）+ 全场最高反差 1.45（白袍对极黑虚空），黑白红三色 |
| | 古海神殿 cobalt | 碧海神阶：版画组合（布点+15°海风排线+交叉）+ 钴蓝海/大理石/赤月宝石，钴蓝夜天/海雾蓝光 |
| | 禁忌档案馆 archive | 原创·五画元素融为一馆：羊皮纸（草筋纤维+颗粒+尘点）+ 烛光古金主色 + 红宝石微光 + 蓝宝石点缀 + 旧铜金属，烛光暖天/羊皮纸暖光，最松 1.2x 最静 0.85x |
