    ...
    fun TextGenEditor(context: Context) {
        ...
        GenericEditor(
            ...
            fields = listOf(
                ...
                Num("rep_pen_range", "rep_pen_range", 0, 4096, 1, false),
                Num("rep_pen_slope", "rep_pen_slope", 0.0, 5.0, 0.01, true),
                Num("tfs", "tfs", 0.0, 5.0, 0.01, true),
                Num("seed", "seed", -1, Int.MAX_VALUE, 1, false),
                Num("mirostat_mode", "mirostat_mode", 0, 2, 1, false),
    ...
    fun NovelEditor(context: Context) {
        GenericEditor(
            ...
            fields = listOf(
                ...
                Num("repetition_penalty_range", "repetition_penalty_range", 0, 8192, 1, false),
                ...
                Num("min_length", "min_length", 0, 1024, 1, false),
    ...
    fun KoboldEditor(context: Context) {
        GenericEditor(
            ...
            fields = listOf(
                ...
                Num("tfs", "tfs", 0.0, 5.0, 0.01, true),
                Num("rep_pen", "rep_pen", 0.0, 5.0, 0.01, true),
                Num("rep_pen_range", "rep_pen_range", 0, 8192, 1, false),
                Num("rep_pen_slope", "rep_pen_slope", 0.0, 5.0, 0.01, true),
                Num("mirostat", "mirostat", 0, 2, 1, false),
                Num("mirostat_tau", "mirostat_tau", 0.0, 10.0, 0.1, true),
                Num("mirostat_eta", "mirostat_eta", 0.0, 1.0, 0.01, true),
                Num("seed", "seed", -1, Int.MAX_VALUE, 1, false),
                Str("grammar", "grammar"),
