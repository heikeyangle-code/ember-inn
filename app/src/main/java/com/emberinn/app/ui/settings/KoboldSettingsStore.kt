...
/** Kobold 预设应用后的设置持久化（官方 data/settings.json 的 kai_settings 语义）。 */
object KoboldSettingsStore {

    private val json = Json { ignoreUnknownKeys = true; prettyPrint = true }

    private fun file(context: Context) = File(context.filesDir, "kobold_settings_v1.json")
