...
function add(id, settings, extra = {}) {
    ...
    cases.push({ id, settings, extra: { ...extra }, expected: JSON.stringify(result) });
}
...
// 追加穷举：1024 停用词截断 / order 覆盖 / logit_bias / erato+logprobs / max_length 边界
add('kayra-stops-1024', { model_novel: 'kayra-v1', temperature: 1, min_length: 0, tail_free_sampling: 1, repetition_penalty: 1, repetition_penalty_range: 1024, repetition_penalty_slope: 0.9, repetition_penalty_frequency: 0, repetition_penalty_presence: 0, top_a: 0, top_p: 1, top_k: 0, min_p: 0, math1_temp: 1, math1_quad: 0, math1_quad_entropy_scale: 0, typical_p: 1, mirostat_lr: 0.1, mirostat_tau: 5, phrase_rep_pen: 'off', order: null, logit_bias: [], banned_tokens: [], prefix: 'vanilla' }, { stoppingStrings: Array.from({ length: 1100 }, (_, i) => 's' + i) });
add('kayra-order-override', { model_novel: 'kayra-v1', temperature: 0.5, min_length: 0, tail_free_sampling: 0.9, repetition_penalty: 1.1, repetition_penalty_range: 1024, repetition_penalty_slope: 0.9, repetition_penalty_frequency: 0, repetition_penalty_presence: 0, top_a: 0, top_p: 0.9, top_k: 0, min_p: 0, math1_temp: 1, math1_quad: 0, math1_quad_entropy_scale: 0, typical_p: 1, mirostat_lr: 0.1, mirostat_tau: 5, phrase_rep_pen: 'off', order: null, logit_bias: [], banned_tokens: [], prefix: 'vanilla' }, { order: ['top_k', 'temperature'] });
add('kayra-logitbias', { model_novel: 'kayra-v1', temperature: 1, min_length: 0, tail_free_sampling: 1, repetition_penalty: 1, repetition_penalty_range: 1024, repetition_penalty_slope: 0.9, repetition_penalty_frequency: 0, repetition_penalty_presence: 0, top_a: 0, top_p: 1, top_k: 0, min_p: 0, math1_temp: 1, math1_quad: 0, math1_quad_entropy_scale: 0, typical_p: 1, mirostat_lr: 0.1, mirostat_tau: 5, phrase_rep_pen: 'off', order: null, logit_bias: [{ bias: 1 }], banned_tokens: [], prefix: 'vanilla' });
add('erato-logbias-logprobs', { model_novel: 'erato-v1', temperature: 1, min_length: 0, tail_free_sampling: 1, repetition_penalty: 1, repetition_penalty_range: 1024, repetition_penalty_slope: 0.9, repetition_penalty_frequency: 0, repetition_penalty_presence: 0, top_a: 0, top_p: 1, top_k: 0, min_p: 0, math1_temp: 1, math1_quad: 0, math1_quad_entropy_scale: 0, typical_p: 1, mirostat_lr: 0.1, mirostat_tau: 5, phrase_rep_pen: 'off', order: null, logit_bias: [{ bias: 2 }], banned_tokens: [], prefix: 'vanilla' }, { requestTokenProbabilities: true, finalPrompt: 'x}' });
add('clio-maxlength-zero', { model_novel: 'clio-v1', temperature: 1, min_length: 0, tail_free_sampling: 1, repetition_penalty: 1, repetition_penalty_range: 1024, repetition_penalty_slope: 0.9, repetition_penalty_frequency: 0, repetition_penalty_presence: 0, top_a: 0, top_p: 1, top_k: 0, min_p: 0, math1_temp: 1, math1_quad: 0, math1_quad_entropy_scale: 0, typical_p: 1, mirostat_lr: 0.1, mirostat_tau: 5, phrase_rep_pen: 'off', order: null, logit_bias: [], banned_tokens: [], prefix: 'vanilla' }, { maxLength: 0 });
add('old-model-cap', { model_novel: 'euterpe-v2', temperature: 1, min_length: 0, tail_free_sampling: 1, repetition_penalty: 1, repetition_penalty_range: 1024, repetition_penalty_slope: 0.9, repetition_penalty_frequency: 0, repetition_penalty_presence: 0, top_a: 0, top_p: 1, top_k: 0, min_p: 0, math1_temp: 1, math1_quad: 0, math1_quad_entropy_scale: 0, typical_p: 1, mirostat_lr: 0.1, mirostat_tau: 5, phrase_rep_pen: 'off', order: null, logit_bias: [], banned_tokens: [], prefix: 'vanilla' }, { maxLength: 9999, maximumOutputLength: 200 });
